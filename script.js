document.addEventListener("DOMContentLoaded", function() {
    ...
    if (blockStory) {
        ...
        // --- SYSTÈME D'OPPORTUNITÉS DYNAMIQUES ---
    const opportunitiesData = {
        robotique: {
            ...
            benefits: "Apprentissage accéléré de Python/C++, maîtrise de cartes Arduino/LEGO Mindstorms, et développement de soft skills très recherchés par les recruteurs (résolution de problèmes complexes)."
        },
        ecriture: {
            icon: "✍️",
        ...
        internationaux: {
            ...
            intro: "Représentez votre pays et brillez sur la scène mondiale.",
    ...
    function openOpportunity(key) {
        ...
        // Génération du HTML de la page de détails
        detailContent.innerHTML = `
            ...
            <div class="mt-10 pt-6 border-t border-slate-100 flex flex-wrap gap-4">
                <a href="#improving" onclick="showSection('improving')" class="bg-blue-900 text-white font-bold px-6 py-3 rounded-xl hover:bg-blue-800 transition text-sm text-center">
